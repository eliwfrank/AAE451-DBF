...
wingloading_M = linspace(1e-8,max_val,1000);
...
wingloading_TO = linspace(1e-8,max_val,1000);
...
powerloading_stall_TO = interp1(wingloading_TO, powerloading_TO, wingloading_stall);
plot(wingloading_stall,powerloading_stall_TO,'ko', 'MarkerFaceColor', "yellow", 'MarkerSize', 10)
